...
data class AdvancedSettingsData(
 ...
 val finalmaskPacket:String="tlshello",val finalmaskLength:Int=5,val finalmaskDelayMs:Int=20,val muxEnabled:Boolean=false,val muxConcurrency:Int=8,
...
class AdvancedSettingsStore(context: Context) {
    ...
    fun save(value: AdvancedSettingsData): AdvancedSettingsData {
        ...
        prefs.edit()
            ...
            .putInt("tunMtu", v.tunMtu).putString("tunAddress", v.tunAddress).putString("nativeDns", v.nativeDns).putString("tunRoute", v.tunRoute)
            .apply()
        mutable.value = v
        return v
    }
    ...
    private fun read(): AdvancedSettingsData {
        ...
        return AdvancedSettingsData(
            ...
            socksAddress=s("socksAddress",d.socksAddress), socksPort=i("socksPort",d.socksPort), socksUdp=b("socksUdp",d.socksUdp), tunMtu=i("tunMtu",d.tunMtu), tunAddress=s("tunAddress",d.tunAddress), nativeDns=s("nativeDns",d.nativeDns), tunRoute=s("tunRoute",d.tunRoute)
        ).validated()
    }
